...
class BrandController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        // Check if this brand is assigned to any product
        $assignedProductsCount = Product::where('brand_id', $id)->count();
    
        if ($assignedProductsCount > 0) {
            // If products exist, show error message
            return redirect('brand')->with('not_permitted', 'Brand "' . $lims_brand_data->title . '" is assigned to products and cannot be deleted!');
        }
