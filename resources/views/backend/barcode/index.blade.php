...
<section>
    <div class="container-fluid">
        <a href="{{route('barcodes.create')}}" class="btn btn-info add-sale-btn"><i class="dripicons-plus"></i> {{__('file.Add New Setting')}}</a>&nbsp;
    </div>
        ...
        <table id="barcode-table" class="table" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>{{__('file.Sticker Sheet setting Name')}}</th>
                    <th>{{__('file.Sticker Sheet setting Description')}}</th>
