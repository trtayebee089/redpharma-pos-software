...
<section>
    <div class="container-fluid">
        ...
        <a href="{{route('biller.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Add Biller')}}</a>&nbsp;
        <a href="#" data-toggle="modal" data-target="#importbiller" class="btn btn-primary"><i class="dripicons-copy"></i> {{__('file.Import Biller')}}</a>
        @endif
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                ...
                                <li>
                                    <a href="{{ route('biller.edit', $biller->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{__('file.edit')}}</a>
                                </li>
                                @endif
                                <li class="divider"></li>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{__('file.Import Biller')}}</h5>
        ...
        <div class="modal-body">
          <p class="italic"><small>{{__('file.The field labels marked with * are required input fields')}}.</small></p>
           ...
           <p>{{__('file.To display Image it must be stored in')}} images/biller {{__('file.directory')}}</p>
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <a href="sample_file/sample_biller.csv" class="btn btn-info btn-block btn-md"><i class="dripicons-download"></i> {{__('file.Download')}}</a>
                    </div>
                </div>
            </div>
