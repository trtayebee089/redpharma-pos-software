...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#create-modal"><i class="dripicons-plus"></i> {{__('file.Add Coupon')}}</button>
    </div>
        ...
        <table id="coupon-table" class="table" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>{{__('file.Coupon Code')}}</th>
                    <th>{{__('file.Type')}}</th>
                    <th>{{__('file.Amount')}}</th>
                    <th>{{__('file.Minimum Amount')}}</th>
                    <th>Qty</th>
                    <th>{{__('file.Available')}}</th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" data-id="{{$coupon->id}}" data-code="{{$coupon->code}}" data-type="{{$coupon->type}}" data-amount="{{$coupon->amount}}" data-minimum_amount="{{$coupon->minimum_amount}}" data-quantity="{{$coupon->quantity}}" data-expired_date="{{$coupon->expired_date}}" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{__('file.edit')}}</button></li>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{__('file.Add Coupon')}}</h5>
                ...
                {!! Form::open(['route' => 'coupons.store', 'method' => 'post']) !!}
                  <div class="row">
                      <div class="col-md-6 form-group">
                          <label>{{__('file.Coupon Code')}} *</label>
                          <div class="input-group">
                              {{Form::text('code',null,array('required' => 'required', 'class' => 'form-control'))}}
                              <div class="input-group-append">
                                  <button type="button" class="btn btn-default btn-sm genbutton">{{__('file.Generate')}}</button>
                              </div>
                          </div>
                      </div>
                      <div class="col-md-6 form-group">
                      ...
                      <div class="col-md-6 form-group minimum-amount">
                          <label>{{__('file.Minimum Amount')}} *</label>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
      <div class="modal-content">
          <div class="modal-header">
              <h5 id="exampleModalLabel" class="modal-title">{{__('file.Update Coupon')}}</h5>
              <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
          </div>
          <div class="modal-body">
            <p class="italic"><small>{{__('file.The field labels marked with * are required input fields')}}.</small></p>
              ...
              <div class="row">
                <div class="col-md-6 form-group">
                    <label>{{__('file.Coupon')}} {{__('file.Code')}} *</label>
                    <div class="input-group">
