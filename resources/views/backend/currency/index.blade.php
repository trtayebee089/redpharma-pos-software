...
<section>
    <div class="container-fluid">
        <button class="btn btn-info" data-toggle="modal" data-target="#createModal"><i class="dripicons-plus"></i> {{__('file.Add Currency')}} </button>&nbsp;
    </div>
        ...
        <table id="currency-table" class="table">
            <thead>
                <tr>
                    ...
                    <th>{{__('file.Currency Name')}}</th>
                    <th>{{__('file.Currency Code')}}</th>
                    <th>{{__('file.Exchange Rate')}}</th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li><button type="button" data-id="{{$currency_data->id}}" data-name="{{$currency_data->name}}" data-code="{{$currency_data->code}}" data-exchange_rate="{{$currency_data->exchange_rate}}" class="edit-btn btn btn-link" data-toggle="modal" data-target="#editModal"><i class="dripicons-document-edit"></i> {{__('file.edit')}}</button></li>
    ...
    <div role="document" class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header">
          <h5 id="exampleModalLabel" class="modal-title">{{__('file.Add Currency')}}</h5>
        ...
        <div class="modal-body">
          <p class="italic"><small>{{__('file.The field labels marked with * are required input fields')}}.</small></p>
            ...
            <div class="form-group">
                <label>{{__('file.Exchange Rate')}} * <i class="dripicons-question" data-toggle="tooltip" title="{{__('file.If this is your default currency, the exchange rate must be 1.')}}"></i></label>
...
<div id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 id="exampleModalLabel" class="modal-title"> {{__('file.Update Currency')}}</h5>
        <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
      </div>
      <div class="modal-body">
          <p class="italic"><small>{{__('file.The field labels marked with * are required input fields')}}.</small></p>
...
<script type="text/javascript">
    ...
    $('#add_exchange_rate,#edit_exchange_rate').on('input',function(){
        ...
        if(exchange_rate == default_exchange_rate){
            var message = "{{__('file.Only default currency can have 1 as exchange rate. Please change the exchange rate of your default currency')}}";
