            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{__('file.Create Custom Field')}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'custom-fields.store', 'method' => 'post']) !!}
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    <label>{{__('file.Field Belongs To')}} *</label>
                                    <select name="belongs_to" required class="form-control">
                                        <option value="">{{__('file.Nothing Selected')}}</option>
                                        <option value="product">{{__('file.Product')}}</option>
                                        <option value="sale">{{__('file.Sale')}}</option>
                                        <option value="purchase">{{__('file.Purchase')}}</option>
                                        <option value="customer">{{__('file.customer')}}</option>
                                    </select>
                                </div>
                                <div class="col-md-4 form-group">
                                	<label>{{__('file.Field Name')}} *</label>
                                    <input type="text" name="name" required class="form-control">
                                </div>
                                <div class="col-md-4 form-group">
                                    <label>{{__('file.Field Type')}} *</label>
                                ...
                                <div class="col-md-4 form-group default-value-1">
                                    <label>{{__('file.Default Value')}}</label>
                                ...
                                <div class="col-md-4 form-group option-value d-none">
                                    <label>{{__('file.Options')}} *</label> <i class="dripicons-question" data-toggle="tooltip" title="{{__('file.Only use for Select, Multi Select, Checkbox, Radio Button types. Populate the field by separating the options by coma. eq. apple,orange,banana')}}"></i>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{__('file.Visibility')}}</label><br>
                                        <label class="radio-inline">
                                            <input type="checkbox" name="is_table"> {{__('file.Show on Table')}}
                                        </label>
                                        &nbsp;
                                        <label class="radio-inline is-invoice-section">
                                          <input type="checkbox" name="is_invoice"> {{__('file.Show on Invoice')}}
                                        </label>
                                    </div>
                                </div>
                                <div class="col-md-2 mt-4">
                                    <input type="checkbox" name="is_required" value="1">
                                    <label>{{__('file.Required')}}</label>
                                </div>
                                <div class="col-md-2 mt-4">
                                    <input type="checkbox" name="is_admin" value="1">
                                    <label>{{__('file.Admin Only')}}</label>
                                </div>
                                <div class="col-md-2 mt-4">
                                    <input type="checkbox" name="is_disable" value="1">
                                    <label>{{__('file.Disabled')}}</label>
                                </div>
