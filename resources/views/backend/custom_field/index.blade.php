...
<section>
    <div class="container-fluid">
        <a href="{{route('custom-fields.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Create Custom Field')}}</a>&nbsp;
    </div>
        ...
        <table id="custom-field-table" class="table">
            <thead>
                <tr>
                    ...
                    <th>{{__('file.Field Belongs To')}}</th>
                    <th>{{__('file.Field Name')}}</th>
                    <th>{{__('file.Type')}}</th>
                    <th>{{__('file.Required')}}</th>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="{{ route('custom-fields.edit', $field->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{__('file.edit')}}</a>
                                </li>
                                <li class="divider"></li>
