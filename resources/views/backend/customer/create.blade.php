                        ...
                        <div class="row">
                            <div class="col-md-4 mt-4">
                                <div class="form-group">
                                    ...
                                    <label>{{__('file.Both Customer and Supplier')}}</label>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__('file.Company Name')}} <span class="asterisk">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__('file.Email')}} <span class="asterisk">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__('file.Tax Number')}}</label>
                                    <input type="text" name="tax_no" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__('file.Address')}} <span class="asterisk">*</span></label>
                                    <input type="text" name="address" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__('file.City')}} <span class="asterisk">*</span></label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__('file.Postal Code')}}</label>
