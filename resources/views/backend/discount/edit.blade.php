                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => ['discounts.update', $lims_discount_data->id], 'method' => 'put']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                	<label>{{__('file.Discount Plan')}} *</label>
                                ...
                                <div class="col-md-3 form-group">
                                	<label>{{__('file.Applicable For')}} *</label>
                                    <select required name="applicable_for" class="form-control">
                                        @if($lims_discount_data->applicable_for == 'All')
                                            <option selected value="All">{{__('file.All Products')}}</option>
                                            <option value="Specific">{{__('file.Specific Products')}}</option>
                                        @else
                                            <option value="All">{{__('file.All Products')}}</option>
                                            <option selected value="Specific">{{__('file.Specific Products')}}</option>
                                        @endif
                                    </select>
                                </div>
                                <div class="col-md-3 mt-4">
                                    ...
                                    @endif
                                    <label>{{__('file.Active')}}</label>
                                </div>
                                <div class="col-md-9 form-group product-selection">
                                	<label>{{__('file.Select Product')}} *</label>
                                	<input type="text" name="product_code" id="product-code" class="form-control" placeholder="{{__('file.Type product code seperated by comma')}}">
                                </div>
                                <div class="col-md-9 form-group product-selection">
                                ...
                                <div class="col-md-4 form-group">
                                	<label>{{__('file.Valid From')}} *</label>
                                ...
                                <div class="col-md-4 form-group">
                                	<label>{{__('file.Valid Till')}} *</label>
                                ...
                                <div class="col-md-4 form-group">
                                	<label>{{__('file.Discount Type')}} *</label>
