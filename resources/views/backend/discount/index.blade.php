...
<section>
    <div class="container-fluid">
        <a href="{{route('discounts.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Create Discount')}}</a>&nbsp;
    </div>
        ...
        <table id="discount-table" class="table">
            <thead>
                <tr>
                    ...
                    <th>{{__('file.name')}}</th>
                    <th>{{__('file.Value')}}</th>
                    <th>{{__('file.Discount Plan')}}</th>
                    <th>{{__('file.Validity')}}</th>
                    <th>{{__('file.Days')}}</th>
                ...
                <tr data-id="{{$discount->id}}">
                    ...
                    <td>
                        @if($discount->product_list)
                            ...
                            @endforeach
                        @else
                            {{__('file.All Products')}}
                        @endif
                    </td>
                    @if($discount->is_active)
                        <td>{{ __('file.Active')}}</td>
                    @else
                        <td>{{ __('file.Inactive')}}</td>
                    @endif
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="{{ route('discounts.edit', $discount->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{__('file.edit')}}</a>
                                </li>
                            </ul>
                        </div>
                    </td>
