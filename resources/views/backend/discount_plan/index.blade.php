...
<section>
    <div class="container-fluid">
        <a href="{{route('discount-plans.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Create Discount Plan')}}</a>&nbsp;
    </div>
                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu edit-options dropdown-menu-right dropdown-default" user="menu">
                                <li>
                                    <a href="{{ route('discount-plans.edit', $discount_plan->id) }}" class="btn btn-link"><i class="dripicons-document-edit"></i> {{__('file.edit')}}</a>
                                </li>
                            </ul>
                        </div>
                    </td>
