    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{__('file.Income List')}}</h3>
            </div>
        ...
        @if(in_array("incomes-add", $all_permission))
            <button class="btn btn-info" data-toggle="modal" data-target="#income-modal"><i class="dripicons-plus"></i> {{__('file.Add Income')}}</button>
        @endif
    </div>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{__('file.Update Income')}}</h5>
                ...
                ?>
                  <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label>{{__('file.Income Category')}} *</label>
