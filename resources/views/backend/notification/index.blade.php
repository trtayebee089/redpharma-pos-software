...
<section>
    <div class="card">
        <div class="card-header mt-2">
            <h3 class="text-center">{{__('file.Notification List')}}</h3>
        </div>
    </div>
        ...
        <table id="notification-table" class="table">
            <thead>
                <tr>
                    ...
                    <th>{{__('file.From')}}</th>
                    <th>{{__('file.To')}}</th>
                    <th>{{__('file.Document')}}</th>
                    <th>{{__('file.Message')}}</th>
                    <th>{{__('file.Reminder Date')}}</th>
            ...
            <tbody>
                ...
                <tr data-id="{{$notification->id}}">
                    ...
                    @if($notification->read_at)
                        <td><div class="badge badge-success">{{__('file.Read')}}</div></td>
                    @else
                        <td><div class="badge badge-danger">{{__('file.Unread')}}</div></td>
                    @endif
                </tr>
                @endforeach
            </tbody>
