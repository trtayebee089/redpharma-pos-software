...
<section>
    <div class="container-fluid">
        @if(in_array("sales-add", $all_permission))
            <a href="{{route('online-sales.create')}}" class="btn btn-info add-sale-btn"><i class="dripicons-plus"></i> {{__('file.Add Sale')}}</a>&nbsp;
            <a href="{{url('online-sales/sale_by_csv')}}" class="btn btn-primary add-sale-btn"><i class="dripicons-copy"></i> {{__('file.Import Sale')}}</a>
        @endif
        <div class="card mt-3">
            <h3 class="text-center mt-3">{{__('file.Filter Sales')}}</h3>
            <div class="card-body">
                {!! Form::open(['route' => 'online-sales.index', 'method' => 'get']) !!}
                <div class="row mt-2">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label><strong>{{__('file.Delivery Status')}}</strong></label>
                            <select id="sale-status" class="form-control" name="sale_status">
                                <option value="0">{{__('file.All')}}</option>
                                <option value="1">{{__('file.Delivered')}}</option>
                                <option value="2">{{__('file.In Transit')}}</option>
                    ...
                    <div class="col-md-2 mt-3">
                        <div class="form-group">
                            <button data-href="{{url('online-sales/export-all')}}" id="btn-download-filter-data" class="btn btn-secondary w-100"><i class="dripicons-copy"></i> Download Excel</button>
                        </div>
                    </div>
