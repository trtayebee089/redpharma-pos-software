                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="stock_warehouse_id[]" value="" id="stock_warehouse_id">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group pos">
                                            <select name="category_id" required class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select Category..." required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Expire Date</strong></label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Stock Quantity')}}</strong> </label>
...
<script type="text/javascript">
    ...
    var listWarehouses = <?php echo json_encode($lims_warehouse_list) ?>;

    $('#warehouse_select').on("change", function(){
        $('#stock_warehouse_id').val($(this).val());
    });
