                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <!--        <input type="text" class="form-control" required value="Standard" disabled>-->
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="selectpicker form-control" title="Select Warehouse..." id="warehouse_select" required>
                                            @foreach($lims_warehouse_list as $category)
                                            <option value="{{$category->id}}" @if($category->id == $lims_warehouse_list->first()->id) selected @endif>{{$category->name}}</option>
                                            @endforeach
                                        </select>
                                        <input type="hidden" name="stock_warehouse_id[]" value="{{ $lims_warehouse_list->first()->id }}" id="stock_warehouse_id">
                                        <input type="hidden" name="type" value="standard">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('file.Expire Date')}}</strong></label>
                                ...
                                @php
                                    $warehouseInfo = \App\Models\Product_Warehouse::where('product_id', $lims_product_data->id)->first();
                                @endphp
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><stong>{{trans('file.Stock Quantity')}}</strong></label>
                                        @foreach($lims_warehouse_list as $warehouse)
                                            <!--<input type="hidden" name="stock_warehouse_id[]" value="{{$warehouse->id}}">-->
                                            <input type="number" name="stock[]" min="0" class="form-control" value="{{$warehouseInfo->qty ?? 0}}">
                                        @endforeach
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mt-3 text-center">
                                    <div class="form-group">
                                        <button class="btn btn-primary w-25" type="submit" id="submit-btn">
                                            {{strtoupper(trans('file.submit'))}}
                                        </button>
                                    </div>
                                </div>
                            </div>
