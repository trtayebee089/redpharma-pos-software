                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    @else
                                    <input type="hidden" name="supplier_id" value="{{Auth::user()->role_id}}">
                                    <input type="hidden" name="warehouse_id" value="1">
                                    @endif
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{__('file.Purchase Status')}}</label>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="order_tax_rate">
                                                <option value="0">{{__('file.No Tax')}}</option>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{__('file.Discount')}}</strong>
                                            </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{__('file.Shipping Cost')}}</strong>
                                            </label>
                                ...
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" id="submit-btn">{{__('file.submit')}}</button>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
