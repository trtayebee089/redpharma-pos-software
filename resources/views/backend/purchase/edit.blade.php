                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{__('file.Reference No')}}</label>
                                    ...
                                    @if(Auth::user()->role_id != 6)
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bill_no" class="form-control" value="{{$lims_purchase_data->bill_no}}" placeholder="Bill No"/>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
