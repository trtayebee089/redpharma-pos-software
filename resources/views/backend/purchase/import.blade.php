                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p>{{__('file.The correct column order is')}} (product_code, quantity, purchase_unit_code, cost, discount_per_unit, tax_name) {{__('file.and you must follow this')}}. {{__('file.All columns are required')}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label></label><br>
                                            <a href="../sample_file/sample_purchase_products.csv" class="btn btn-primary btn-block btn-lg"><i class="dripicons-download"></i> {{__('file.Download Sample File')}}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
