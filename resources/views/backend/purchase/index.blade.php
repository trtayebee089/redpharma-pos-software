    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{__('file.Purchase List')}}</h3>
            </div>
            ...
            <div class="row ml-1 mt-2">
                ...
                <div class="col-md-2 mt-3">
                    <div class="form-group">
                        <button class="btn btn-primary" id="filter-btn" type="submit">{{__('file.submit')}}</button>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}
        ...
        @if(in_array("purchases-add", $all_permission))
             ...
             <a href="{{route('purchases.new.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Add Purchase')}}</a>&nbsp;
             @else
            <a href="{{route('purchases.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Add Purchase')}}</a>&nbsp;
            @endif
            <a href="{{url('purchases/purchase_by_csv')}}" class="btn btn-primary"><i class="dripicons-copy"></i> {{__('file.Import Purchase')}}</a>
        @endif
    </div>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{__('file.Purchase Details')}}</i>
                </div>
            </div>
        </div>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{__('file.All Payment')}}</h5>
...
<script type="text/javascript">
    ...
    $('#purchase-table').DataTable( {
        ...
        "columns": columns,
        'language': {
            /*'searchPlaceholder': "{{__('file.Type date or purchase reference...')}}",*/
