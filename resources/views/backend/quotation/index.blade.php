    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{__('file.Quotation List')}}</h3>
            </div>
        ...
        @if(in_array("quotes-add", $all_permission))
            <a href="{{route('quotations.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Add Quotation')}}</a>&nbsp;
        @endif
    </div>
...
<script type="text/javascript">
    ...
    $('#quotation-table').DataTable( {
        ...
        'language': {
            /*'searchPlaceholder': "{{__('file.Type date or quotation reference...')}}",*/
