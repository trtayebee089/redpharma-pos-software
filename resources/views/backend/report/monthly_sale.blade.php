	...
	<div class="container-fluid">
		<div class="card">
			<div class="card-body">
				...
				<h4 class="text-center">{{__('file.Monthly Sale Report')}} &nbsp;&nbsp;
				...
				<div class="table-responsive mt-4">
					<table class="table table-bordered" style="border-top: 1px solid #dee2e6; border-bottom: 1px solid #dee2e6;">
						<thead>
							<tr>
								<th><a href="{{url('report/monthly_sale/'.($year-1))}}"><i class="fa fa-arrow-left"></i> {{__('file.Previous')}}</a></th>
						    	<th colspan="10" class="text-center">{{$year}}</th>
						    	<th><a href="{{url('report/monthly_sale/'.($year+1))}}">{{__('file.Next')}} <i class="fa fa-arrow-right"></i></a></th>
						    </tr>
						</thead>
					    <tbody>
						    <tr>
