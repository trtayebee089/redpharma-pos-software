...
<section class="forms">
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{__('file.Product Report')}}</h3>
            </div>
            ...
            <div class="row mb-3 product-report-filter">
                ...
                <div class="col-md-4 mt-3">
                    <div class="form-group row">
                        <label class="d-tc mt-2"><strong>{{__('file.Choose Warehouse')}}</strong> &nbsp;</label>
                        <div class="d-tc">
    ...
    <div class="table-responsive">
        <table id="product-report-table" class="table table-hover" style="width: 100%">
            <thead>
                <tr>
                    <th width="3%" class="not-exported"></th>
                    <th width="15%">{{__('file.Product')}}</th>
                    <th width="10%">{{__('file.category')}}</th>
                    <th width="8%">{{__('file.Purchased Amount')}}</th>
                    <th width="6%">{{__('file.Purchased')}} {{__('file.qty')}}</th>
                    <th width="8%">{{__('file.Sold Amount')}}</th>
                    <th width="6%">{{__('file.Sold')}} {{__('file.qty')}}</th>
                    <th width="8%">Returned Amount</th>
                    <th width="6%">Returned Qty</th>
                    <th width="8%">Purchase Returned Amount</th>
                    <th width="6%">Purchase Returned Qty</th>
                    <th width="7%">{{__('file.profit')}}</th>
                    <th width="5%">{{__('file.In Stock')}}</th>
                    <th width="10%">{{__('file.Stock Worth (Price/Cost)')}}</th>
                </tr>
            </thead>
...
<script type="text/javascript">
    ...
    function datatable_sum(dt_selector, is_calling_first) {
        if (dt_selector.rows( '.selected' ).any() && is_calling_first) {
            ...
            $( dt_selector.column( 13 ).footer() ).html(stock_worth_price.toFixed({{$general_setting->decimal}}) + ' / ' + stock_worth_cost.toFixed({{$general_setting->decimal}}));
