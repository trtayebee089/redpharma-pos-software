...
@section('content')
<section>
    <h3 class="text-center">{{__('file.Summary Report')}}</h3>
                    ...
                    <div class="d-tc">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit">{{__('file.submit')}}</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid">
        <div class="row mt-4">
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        <h3><i class="fa fa-heart"></i> {{__('file.Purchase')}}</h3>
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">{{__('file.grand total')}} <span class="float-right"> {{number_format((float)$purchase[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Purchase')}} <span class="float-right">{{$total_purchase}}</span></p>
                            <p class="mt-2">{{__('file.Paid')}} <span class="float-right">{{number_format((float)$purchase[0]->paid_amount, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Tax')}} <span class="float-right">{{number_format((float)$purchase[0]->tax, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Discount')}} <span class="float-right">{{number_format((float)$purchase[0]->discount, $general_setting->decimal, '.', '')}}</span></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3><i class="fa fa-shopping-cart"></i> {{__('file.Sale')}}</h3>
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">{{__('file.grand total')}} <span class="float-right"> {{number_format((float)$sale[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Shipping Cost')}} <span class="float-right"> {{number_format((float)$sale[0]->shipping_cost, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Sale')}} <span class="float-right">{{$total_sale}}</span></p>
                            <p class="mt-2">{{__('file.Paid')}} <span class="float-right">{{number_format((float)$sale[0]->paid_amount, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Tax')}} <span class="float-right">{{number_format((float)$sale[0]->tax, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Discount')}} <span class="float-right">{{number_format((float)$sale[0]->discount, $general_setting->decimal, '.', '')}}</span></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3><i class="fa fa-random "></i> {{__('file.Sale Return')}}</h3>
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">{{__('file.grand total')}} <span class="float-right"> {{number_format((float)$return[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Return')}} <span class="float-right">{{$total_return}}</span></p>
                            <p class="mt-2">{{__('file.Tax')}} <span class="float-right">{{number_format((float)$return[0]->tax, $general_setting->decimal, '.', '')}}</span></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3><i class="fa fa-random "></i> {{__('file.Purchase Return')}}</h3>
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">{{__('file.grand total')}} <span class="float-right"> {{number_format((float)$purchase_return[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Return')}} <span class="float-right">{{$total_purchase_return}}</span></p>
                            <p class="mt-2">{{__('file.Tax')}} <span class="float-right">{{number_format((float)$purchase_return[0]->tax, $general_setting->decimal, '.', '')}}</span></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card"> 
                    <div class="card-body">
                        ...
                        <h3><i class="fa fa-money"></i> {{__('file.profit')}} / {{__('file.Loss')}}</h3>
                        <hr>
                        <div class="mt-3">
                            <p class="mt-2">{{__('file.Sale')}} <span class="float-right">{{number_format((float)$sale[0]->grand_total, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.Product Cost')}} <span class="float-right">- {{number_format((float)$product_cost, $general_setting->decimal, '.', '')}}</span></p>
                            <p class="mt-2">{{__('file.profit')}} <span class="float-right"> {{number_format((float)($sale[0]->grand_total - $product_cost), $general_setting->decimal, '.', '')}}</span></p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            <p class="mt-2">{{trans('file.Order Discount')}} <span class="float-right">- {{number_format((float)$totalDiscount, $general_setting->decimal, '.', '')}}</span></p>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- <p class="mt-2">{{trans('file.Sale')}} <span class="float-right">+ {{number_format((float)($sale[0]->grand_total), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Shipping Cost')}} <span class="float-right">- {{number_format((float)($sale[0]->shipping_cost), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Tax')}} <span class="float-right">- {{number_format((float)($sale[0]->tax), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Product Cost')}} <span class="float-right">- {{number_format((float)($product_cost), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Tax')}} <span class="float-right">- {{number_format((float)($product_tax), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Return')}} <span class="float-right">- {{number_format((float)($return[0]->grand_total), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Tax')}} <span class="float-right">- {{number_format((float)($return[0]->tax), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Purchase Return')}} <span class="float-right">+ {{number_format((float)($purchase_return[0]->grand_total), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Tax')}} <span class="float-right">- {{number_format((float)($purchase_return[0]->tax), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Expense')}} <span class="float-right">- {{number_format((float)($expense), $general_setting->decimal, '.', '')}}</span></p>
                        <p class="mt-1">{{trans('file.Income')}} <span class="float-right">+ {{number_format((float)($income), $general_setting->decimal, '.', '')}} </span></p> --}}
