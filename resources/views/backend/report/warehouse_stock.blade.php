					...
					<div class="col-md-5 offset-md-3 mt-2">
						<div class="pie-chart">
							@php
			                 ...
			                 @endphp
					      	<canvas id="pieChart" data-color="{{$color}}" data-color_rgba="{{$color_rgba}}" data-price={{$total_price}} data-cost={{$total_cost}} width="10" height="10" data-label1="{{__('file.Stock Value by Price')}}" data-label2="{{__('file.Stock Value by Cost')}}" data-label3="{{__('file.Estimate Profit')}}"> </canvas>
					    </div>
					</div>
				</div>
			</div>
