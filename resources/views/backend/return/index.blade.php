    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{__('file.Sale Return List')}}</h3>
            </div>
        ...
        @if(in_array("returns-add", $all_permission))
            <a href="#" data-toggle="modal" data-target="#add-sale-return" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Add Return')}}</a>
        @endif
    </div>
