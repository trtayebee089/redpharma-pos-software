                        ...
                        <div class="row">
                            <div class="col-md-12">
                                            ...
                                            <table id="myTable" class="table table-hover order-list">
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        ...
                                                        <input type="hidden" class="unit-cost" value="{{$product_purchase->total/$product_purchase->qty ?? 0}}">
                                                        <input type="hidden" name="product_variant_id[]" value="{{$product_variant_id ?? ''}}"/>
                                                        <input type="hidden" class="product-cost" name="product_cost[]" value="{{$product_cost ?? 0}}"/>
                                                        <input type="hidden" class="purchase-unit" name="purchase_unit[]" value="{{$unit_name ?? ''}}"/>
                                                        <input type="hidden" class="net_unit_cost" name="net_unit_cost[]" value="{{$product_purchase->net_unit_cost ?? 0}}" />
                                                        <input type="hidden" class="discount-value" name="discount[]" value="{{$product_purchase->discount ?? 0}}" />
                                                        <input type="hidden" class="tax-rate" name="tax_rate[]" value="{{$product_purchase->tax_rate ?? 0}}"/>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>{{__('file.Return Note')}}</label>
