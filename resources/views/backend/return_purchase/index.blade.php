    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{__('file.Purchase Return List')}}</h3>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4 mt-3 @if(\Auth::user()->role_id > 2){{'d-none'}}@endif">
                    <div class="d-flex">
                        <label class="">{{__('file.Warehouse')}} &nbsp;</label>
                        <div class="">
        ...
        @if(in_array("purchase-return-add", $all_permission))
            <a href="#" data-toggle="modal" data-target="#add-purchase-return" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Add Return')}}</a>
        @endif
    </div>
      ...
      <div class="modal-content">
        ...
        <div class="row">
            ...
            <div class="col-md-12 text-center">
                <i style="font-size: 15px;">{{__('file.Purchase Return Details')}}</i>
            </div>
        </div>
    </div>
