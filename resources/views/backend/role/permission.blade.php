                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h4>{{ __('file.Group Permission') }}</h4>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="4" class="text-center">
                                                <div class="checkbox">
                                                    ...
                                                    <label for="select_all">{{ __('file.Permissions') }}</label>
                                                </div>
                                            </th>
                                        </tr>
                                        <tr>
                                            <th class="text-center">{{ __('file.View') }}</th>
                                            <th class="text-center">{{ __('file.add') }}</th>
                                            <th class="text-center">{{ __('file.edit') }}</th>
                                            <th class="text-center">{{ __('file.delete') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>{{ __('file.Purchase Payment') }}</td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue checked" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
										...
										<tr>
                                            ...
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('riders-index', $all_permission))
                                                            <input type="checkbox" value="1" id="riders-index" name="riders-index" checked>
                                                        @else
                                                            <input type="checkbox" value="1" id="riders-index" name="riders-index">
                                                        @endif
                                                        <label for="riders-index"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    ...
                                                    <div class="checkbox">
                                                        @if (in_array('riders-add', $all_permission))
                                                            <input type="checkbox" value="1" id="riders-add"
                                                                name="riders-add" checked>
                                                        @else
                                                            <input type="checkbox" value="1" id="riders-add"
                                                                name="riders-add">
                                                        @endif
                                                        <label for="riders-add"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('riders-edit', $all_permission))
                                                            <input type="checkbox" value="1" id="riders-edit"
                                                                name="riders-edit" checked>
                                                        @else
                                                            <input type="checkbox" value="1" id="riders-edit"
                                                                name="riders-edit">
                                                        @endif
                                                        <label for="riders-edit"></label>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="icheckbox_square-blue" aria-checked="false"
                                                    aria-disabled="false">
                                                    <div class="checkbox">
                                                        @if (in_array('riders-delete', $all_permission))
                                                            <input type="checkbox" value="1" id="riders-delete"
                                                                name="riders-delete" checked>
                                                        @else
                                                            <input type="checkbox" value="1" id="riders-delete"
                                                                name="riders-delete">
                                                        @endif
                                                        <label for="riders-delete"></label>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>{{ __('file.dashboard') }}</td>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="revenue_profit_summary"
                                                                class="padding05">{{ __('file.Revenue and Profit Summary') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="cash_flow"
                                                                class="padding05">{{ __('file.Cash Flow') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="monthly_summary"
                                                                class="padding05">{{ __('file.Monthly Summary') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="yearly_report"
                                                                class="padding05">{{ __('file.yearly report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="account-index"
                                                                class="padding05">{{ __('file.Account') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="money-transfer"
                                                                class="padding05">{{ __('file.Money Transfer') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="balance-sheet"
                                                                class="padding05">{{ __('file.Balance Sheet') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="account-statement-permission"
                                                                class="padding05">{{ __('file.Account Statement') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="department"
                                                                class="padding05">{{ __('file.Department') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="attendance"
                                                                class="padding05">{{ __('file.Attendance') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="payroll"
                                                                class="padding05">{{ __('file.Payroll') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="holiday"
                                                                class="padding05">{{ __('file.Holiday Approve') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="profit-loss"
                                                                class="padding05">{{ __('file.Summary Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="best-seller"
                                                                class="padding05">{{ __('file.Best Seller') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="daily-sale"
                                                                class="padding05">{{ __('file.Daily Sale') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="monthly-sale"
                                                                class="padding05">{{ __('file.Monthly Sale') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="daily-purchase"
                                                                class="padding05">{{ __('file.Daily Purchase') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="monthly-purchase"
                                                                class="padding05">{{ __('file.Monthly Purchase') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="product-report"
                                                                class="padding05">{{ __('file.Product Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="payment-report"
                                                                class="padding05">{{ __('file.Payment Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="sale-report"
                                                                class="padding05">{{ __('file.Sale Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="sale-report-chart"
                                                                class="padding05">{{ __('file.Sale Report Chart') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="warehouse-report"
                                                                class="padding05">{{ __('file.Warehouse Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="warehouse-stock-report"
                                                                class="padding05">{{ __('file.Warehouse Stock Chart') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="product-expiry-report"
                                                                class="padding05">{{ __('file.Product Expiry Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="dso-report"
                                                                class="padding05">{{ __('file.Daily Sale Objective Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="product-qty-alert"
                                                                class="padding05">{{ __('file.Product Quantity Alert') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="user-report"
                                                                class="padding05">{{ __('file.User Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="biller-report"
                                                                class="padding05">{{ __('file.Biller Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="customer-report"
                                                                class="padding05">{{ __('file.Customer Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="supplier-report"
                                                                class="padding05">{{ __('file.Supplier Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="supplier-due-report"
                                                                class="padding05">{{ __('file.Supplier Due Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="due-report"
                                                                class="padding05">{{ __('file.Customer Due Report') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('addons', $all_permission))
                                                                <input type="checkbox" value="1" id="addons"
                                                                    name="addons" checked>
                                                            @else
                                                                <input type="checkbox" value="1" id="addons"
                                                                    name="addons">
                                                            @endif
                                                            <label for="addons" class="padding05">Addons
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="custom_field"
                                                                class="padding05">{{ __('file.Custom Field') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="all_notification"
                                                                class="padding05">{{ __('file.All Notification') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="send_notification"
                                                                class="padding05">{{ __('file.Send Notification') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="discount_plan"
                                                                class="padding05">{{ __('file.Discount Plan') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="discount"
                                                                class="padding05">{{ __('file.Discount') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="warehouse"
                                                                class="padding05">{{ __('file.Warehouse') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="customer_group"
                                                                class="padding05">{{ __('file.Customer Group') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                ...
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="currency"
                                                                class="padding05">{{ __('file.Currency') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="backup_database"
                                                                class="padding05">{{ __('file.Backup Database') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="general_setting"
                                                                class="padding05">{{ __('file.General Setting') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="mail_setting"
                                                                class="padding05">{{ __('file.Mail Setting') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('payment_gateway_setting', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="payment_gateway_setting"
                                                                    name="payment_gateway_setting" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="payment_gateway_setting"
                                                                    name="payment_gateway_setting">
                                                            @endif
                                                            <label for="payment_gateway_setting"
                                                                class="padding05">Payment Gateway &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="sms_setting"
                                                                class="padding05">{{ __('file.SMS Setting') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="create_sms"
                                                                class="padding05">{{ __('file.Create SMS') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="pos_setting"
                                                                class="padding05">{{ __('file.POS Setting') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="hrm_setting"
                                                                class="padding05">{{ __('file.HRM Setting') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('barcode_setting', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="barcode_setting" name="barcode_setting" checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="barcode_setting" name="barcode_setting">
                                                            @endif
                                                            <label for="barcode_setting" class="padding05">Barcode
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            @if (in_array('language_setting', $all_permission))
                                                                <input type="checkbox" value="1"
                                                                    id="language_setting" name="language_setting"
                                                                    checked>
                                                            @else
                                                                <input type="checkbox" value="1"
                                                                    id="language_setting" name="language_setting">
                                                            @endif
                                                            <label for="language_setting" class="padding05">Language
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="reward_point_setting"
                                                                class="padding05">{{ __('file.Reward Point Setting') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                ...
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="category"
                                                                class="padding05">{{ __('file.category') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="packing_slip_challan"
                                                                class="padding05">{{ __('file.Packing Slip & Challan') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span class="delivery-section">
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="delivery"
                                                                class="padding05">{{ __('file.Delivery') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="stock_count"
                                                                class="padding05">{{ __('file.Stock Count') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="adjustment"
                                                                class="padding05">{{ __('file.Adjustment') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="gift_card"
                                                                class="padding05">{{ __('file.Gift Card') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                <span>
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            @endif
                                                            <label for="coupon"
                                                                class="padding05">{{ __('file.Coupon') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="product_history"
                                                                class="padding05">{{ __('file.Product History') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="print_barcode"
                                                                class="padding05">{{ __('file.print_barcode') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="empty_database"
                                                                class="padding05">{{ __('file.Empty Database') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="today_sale"
                                                                class="padding05">{{ __('file.Today Sale') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
                                                    ...
                                                    <div aria-checked="false" aria-disabled="false">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="today_profit"
                                                                class="padding05">{{ __('file.Today Profit') }}
                                                                &nbsp;&nbsp;</label>
                                                        </div>
                                                    </div>
                                                </span>
