                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row">
                                    ...
                                    @endif
                                    <input type="hidden" name="currency_id" value="{{ $currency_list->first()->id }}"/>
                                    <input type="hidden" name="exchange_rate" value="{{ $currency_list->first()->exchange_rate }}"/>
                                    <!--<div class="col-md-2">-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label>{{__('file.Currency')}} *</label>-->
                                    ...
                                    <!--        <label>{{__('file.Exchange Rate')}} *</label>-->
                                    <!--    </div>-->
                                ...
                                <div class="row mt-3">
                                    <input type="hidden" value="0" name="order_tax_rate"/>
                                    <!--<div class="col-md-4">-->
                                    <!--    <div class="form-group">-->
                                    <!--        <label>{{__('file.Order Tax')}}</label>-->
                                    ...
                                    <!--    <div class="form-group">-->
                                    <!--        <label>-->
                                    <!--            {{__('file.Shipping Cost')}}-->
                                    <!--        </label>-->
                                    <!--        <input type="number" name="shipping_cost" class="form-control" step="any"/>-->
                                    <!--    </div>-->
                                    <!--</div>-->
                                    <input type="hidden" name="shipping_cost" class="form-control" step="any"/>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{__('file.Attach Document')}}</label> <i class="dripicons-question" data-toggle="tooltip" title="Only jpg, jpeg, png, gif, pdf, csv, docx, xlsx and txt file is supported"></i>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>{{__('file.Sale Status')}} *</label>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>{{__('file.Payment Status')}} *</label>
                                ...
                                <div class="form-group" style="text-align: center;">
                                    ...
                                    <button id="submit-button" type="button" class="btn btn-primary" style="padding: 10px 70px; margin: auto;">SUBMIT</button>
                                </div>
                            </div>
                        </div>
                        {!! Form::close() !!}
...
function calculateGrandTotal() {
    ...
    var order_tax = parseFloat($('input[name="order_tax_rate"]').val());
    if(!currencyChange)
