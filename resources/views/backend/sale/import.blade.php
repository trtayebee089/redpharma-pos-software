                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p>{{__('file.The correct column order is')}} (product_code, quantity, sale_unit_code, price, discount_per_unit, tax_name) {{__('file.and you must follow this')}}. {{__('file.For Digital product sale_unit will be n/a')}}. {{__('file.All columns are required')}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label></label><br>
                                            <a download href="../sample_file/sample_sale_products.csv" class="btn btn-primary btn-block btn-lg"><i class="dripicons-download"></i> {{__('file.Download Sample File')}}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>
                                                <strong>{{__('file.Order Discount')}}</strong>
                                            </label>
