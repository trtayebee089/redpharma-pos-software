...
<section>
    <div class="container-fluid">
        @if(in_array("sales-add", $all_permission))
            <a href="{{route('sales.create')}}" class="btn btn-info add-sale-btn"><i class="dripicons-plus"></i> {{__('file.Add Sale')}}</a>&nbsp;
            <a href="{{url('sales/sale_by_csv')}}" class="btn btn-primary add-sale-btn"><i class="dripicons-copy"></i> {{__('file.Import Sale')}}</a>
        @endif
        <div class="card mt-3">
            <h3 class="text-center mt-3">{{__('file.Filter Sales')}}</h3>
            <div class="card-body">
                {!! Form::open(['route' => 'sales.index', 'method' => 'get']) !!}
                <div class="row mt-2">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label><strong>{{__('file.Date')}}</strong></label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label><strong>{{__('file.Sale Status')}}</strong></label>
                            <select id="sale-status" class="form-control" name="sale_status">
                                <option value="0">{{__('file.All')}}</option>
                                <option value="1">{{__('file.Completed')}}</option>
                                <option value="2">{{__('file.Pending')}}</option>
                                <option value="4">{{__('file.Returned')}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label><strong>{{__('file.Payment Status')}}</strong></label>
                            <select id="payment-status" class="form-control" name="payment_status">
                                <option value="0">{{__('file.All')}}</option>
                                <option value="1">{{__('file.Pending')}}</option>
                                <option value="2">{{__('file.Due')}}</option>
                                <option value="3">{{__('file.Partial')}}</option>
                                <option value="4">{{__('file.Paid')}}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 mt-3">
                        <div class="form-group">
                            <button data-href="{{url('sales/export-all')}}" id="btn-download-filter-data" class="btn btn-secondary w-100"><i class="dripicons-copy"></i> Download Excel</button>
                        </div>
                    </div>
        ...
        <table id="sale-table" class="table sale-list" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th width="10%">{{__('file.date')}}</th>
                    <th width="10%">{{__('file.reference')}}</th>
                    <th width="10%">Billed By</th>
                    <th width="10%">{{__('file.customer')}}</th>
                    <th width="18%">{{__('file.Products')}}</th>
                    <th width="10%">{{__('file.Total Quantity')}}</th>
                    <th width="8%">{{__('file.grand total')}}</th>
                    <th width="8%">{{__('file.Paid')}}</th>
                    <th width="8%">{{__('file.Due')}}</th>
...
<div id="view-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{__('file.All')}} {{__('file.Payment')}}</h5>
...
<div id="add-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{__('file.Add Payment')}}</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
...
<div id="edit-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{__('file.Update Payment')}}</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
...
<div id="add-delivery" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{__('file.Add Delivery')}}</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label>{{__('file.Delivery Reference')}}</label>
                        <p id="dr"></p>
                    </div>
                    <div class="col-md-6 form-group">
                        <label>{{__('file.Sale Reference')}}</label>
                        <p id="sr"></p>
                    </div>
                    <div class="col-md-12 form-group">
                        <label>{{__('file.Status')}} *</label>
                        <select name="status" required class="form-control selectpicker">
                            <option value="1">{{__('file.Packing')}}</option>
                            <option value="2">{{__('file.Delivering')}}</option>
                            <option value="3">{{__('file.Delivered')}}</option>
                        </select>
                    </div>
                    <div class="col-md-6 form-group">
                        <label>{{__('file.Courier')}}</label>
                    ...
                    <div class="col-md-6 mt-2 form-group">
                        <label>{{__('file.Delivered By')}}</label>
                        <input type="text" name="delivered_by" class="form-control">
                    </div>
                    <div class="col-md-6 mt-2 form-group">
                        <label>{{__('file.Recieved By')}} </label>
                    ...
                    <div class="col-md-6 form-group">
                        <label>{{__('file.Attach File')}}</label>
...
<div id="send-sms" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title">{{__('file.Send SMS')}}</h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                <form action="{{ route('sale.sendsms') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-1">
                            <label>{{__('file.SMS Template')}}</label>
                    ...
                    <button type="submit" class="btn btn-primary mt-2">{{__('file.submit')}}</button>
                </form>
            </div>
        </div>
    </div>
