            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{__('file.Create SMS')}}</h4>
                    </div>
                    <div class="card-body">
                        <p class="italic"><small>{{__('file.The field labels marked with * are required input fields')}}.<strong>{{__('file.Add mobile numbers by selecting the customers')}}</strong></small></p>
