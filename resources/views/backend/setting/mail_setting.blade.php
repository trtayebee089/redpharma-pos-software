                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 form-group">
                                <label>{{__('file.Mail From Name')}} *</label>
                            ...
                            <div class="col-md-4 form-group">
                                <label>{{__('file.Encryption')}} *</label>
