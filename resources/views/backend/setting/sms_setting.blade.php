                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label>{{__('file.Gateway')}} *</label>
                                        <select class="form-control" name="gateway">
                                            <option selected disabled>{{__('file.Select SMS gateway...')}}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label class="mt-2"><strong>{{__('file.Default')}}</strong></label>
                                      </div>
                                    <div class="form-group">
                                        <input type="submit" value="{{__('file.submit')}}" class="btn btn-primary">
                                        <a href="https://sms.tonkra.com/account/top-up" type="button" target="_blank" class="btn btn-secondary tonkra">{{ __('file.Top Up') }}</a>
                                    </div>
                                </div>
                            </div>
                        {!! Form::close() !!}
