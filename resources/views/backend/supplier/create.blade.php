                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__('file.Company Name')}} *</label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>{{__('file.VAT Number')}}</label>
                            ...
                            <div class="col-md-2 mt-4">
                                <div class="form-group">
                                    <input id="as_user" type="checkbox" name="as_user" value="1" />&nbsp;
                                    <label for="as_user">{{ "Login as Supplier"}}</label>
                                </div>
                            </div>
                            <div class="col-md-12">
