                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{__('file.From Warehouse')}} *</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>{{__('file.To Warehouse')}} *</label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control selectpicker">
                                                ...
                                                <option value="3">{{__('file.Sent')}}</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <p>{{__('file.The correct column order is')}} (product_code, quantity, product_unit, product_cost, tax_name) {{__('file.and you must follow this')}}. {{__('file.All columns are required')}}</p>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label></label><br>
                                            <a href="../sample_file/sample_transfer_products.csv" class="btn btn-primary btn-block btn-lg"><i class="dripicons-download"></i> {{__('file.Download Sample File')}}</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
