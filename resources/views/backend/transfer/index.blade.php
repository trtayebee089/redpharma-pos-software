...
<section>
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3 mt-3 @if(\Auth::user()->role_id > 2){{'d-none'}}@endif">
                    <div class="d-flex">
                        <label class="">{{__('file.From Warehouse')}} &nbsp;</label>
                        <div class="">
                ...
                <div class="col-md-3 mt-3 @if(\Auth::user()->role_id > 2){{'d-none'}}@endif">
                    <div class="d-flex">
                        <label class="">{{__('file.To Warehouse')}} &nbsp;</label>
                        <div class="">
        ...
        @if(in_array("transfers-add", $all_permission))
            <a href="{{route('transfers.create')}}" class="btn btn-info"><i class="dripicons-plus"></i> {{__('file.Add Transfer')}}</a>&nbsp;
        @endif
    </div>
        ...
        <table id="transfer-table" class="table transfer-list" style="width: 100%">
            <thead>
                <tr>
                    ...
                    <th>{{__('file.Warehouse')}}({{__('file.From')}})</th>
                    <th>{{__('file.Warehouse')}}({{__('file.To')}})</th>
                    <th>{{__('file.product')}} {{__('file.Cost')}}</th>
                    <th>{{__('file.product')}} {{__('file.Tax')}}</th>
                    <th>{{__('file.grand total')}}</th>
                    <th>{{trans("file.Status")}}</th>
                    <th>{{__('file.Email Sent')}}</th>
        ...
        <div class="container mt-3 pb-2 border-bottom">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <i style="font-size: 15px;">{{__('file.Transfer Details')}}</i>
                </div>
            </div>
        </div>
