            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header d-flex align-items-center">
                        <h4>{{__('file.Update User Profile')}}</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>{{__('file.UserName')}} *</strong> </label>
                                ...
                                <div class="form-group">
                                    <label>{{__('file.Email')}} *</strong> </label>
