                        ...
                        <div class="filesArea">
                                ...
                                @foreach ($versionUpgradeSettings->files as $item)
                                    <div class="row">
                                        <div class="col-8 form-group">
                                            <label>{{__('dbFile Name')}}</label>
                                            <input value="{{ $item->file_name }}" type="text" name="file_name[]" class="form-control" placeholder="{{__('dbType File Name')}}">
                                        </div>
                            ...
                            @else
                                <div class="row">
                                    <div class="col-8 form-group">
                                        <label>{{__('dbFile Name')}}</label>
                                        <input type="text" name="file_name[]" class="form-control" placeholder="{{__('dbType File Name')}}">
                                    </div>
                                    <div class="form-group">
                                        <label>@lang('file.Delete')</label><br>
                                        <span class="btn btn-default btn-sm del-row"><i class="dripicons-trash"></i></span>
                        ...
                        <div class="logArea">
                            @if (isset($versionUpgradeSettings->logs))
                                @foreach ($versionUpgradeSettings->logs as $item)
                                    <div class="row">
                                        <div class="col-8 form-group">
                                            <label>{{__('dbType Log')}}</label>
                                            <input value="{{ $item->text }}" type="text" name="text[]" class="form-control" placeholder="{{__('dbType Log')}}">
                                        </div>
                                        <div class="form-group">
                                            <label>@lang('file.Delete')</label><br>
                            ...
                            @else
                                <div class="row">
                                    <div class="col-8 form-group">
                                        <label>{{__('dbType Log')}}</label>
                                        <input type="text" name="text[]" class="form-control" placeholder="{{__('dbType Log')}}">
                                    </div>
                                    <div class="form-group">
                                        <label>@lang('file.Delete')</label><br>
                                        <span class="btn btn-default btn-sm del-row-log"><i class="dripicons-trash"></i></span>
