    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h4 class="text-center"><?php echo e(__('file.Customer Due Report')); ?></h4>
            </div>
            <?php echo Form::open(['route' => 'report.customerDueByDate', 'method' => 'post']); ?>

            <div class="col-md-6 offset-md-3 mt-4 mb-3">
                <div class="form-group row">
                    <label class="d-tc mt-2"><strong><?php echo e(__('file.Choose Your Date')); ?></strong> &nbsp;</label>
                    <div class="d-tc">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button class="btn btn-primary" type="submit"><?php echo e(__('file.submit')); ?></button>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <table id="report-table" class="table table-hover" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th><?php echo e(__('file.Returned Amount')); ?></th>
                    <th><?php echo e(__('file.Paid')); ?></th>
                    <th><?php echo e(__('file.Due')); ?></th>
                </tr>
            </thead>

            <tfoot class="tfoot active">
                <th></th>
                <th><?php echo e(__('file.Total')); ?>:</th>
                <th></th>
                <th></th>
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01-TR-LARAVEL\redpharma-pos-software\resources\views/backend/report/due_report.blade.php ENDPATH**/ ?>