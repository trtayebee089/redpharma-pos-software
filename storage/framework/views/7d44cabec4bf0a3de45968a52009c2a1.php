...
<section>
    <div class="container-fluid">
        <?php if(in_array("sales-add", $all_permission)): ?>
            <a href="<?php echo e(route('online-sales.create')); ?>" class="btn btn-info add-sale-btn"><i class="dripicons-plus"></i> <?php echo e(__('file.Add Sale')); ?></a>&nbsp;
            <a href="<?php echo e(url('online-sales/sale_by_csv')); ?>" class="btn btn-primary add-sale-btn"><i class="dripicons-copy"></i> <?php echo e(__('file.Import Sale')); ?></a>
        <?php endif; ?>
        <div class="card mt-3">
            <h3 class="text-center mt-3"><?php echo e(__('file.Filter Sales')); ?></h3>
            <div class="card-body">
                <?php echo Form::open(['route' => 'online-sales.index', 'method' => 'get']); ?>
                ...
                <div class="row mt-2">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label><strong><?php echo e(__('file.Delivery Status')); ?></strong></label>
                            <select id="sale-status" class="form-control" name="sale_status">
                                <option value="0"><?php echo e(__('file.All')); ?></option>
                                <option value="1"><?php echo e(__('file.Delivered')); ?></option>
                                <option value="2"><?php echo e(__('file.In Transit')); ?></option>
                    ...
                    <div class="col-md-2 mt-3">
                        <div class="form-group">
                            <button data-href="<?php echo e(url('online-sales/export-all')); ?>" id="btn-download-filter-data" class="btn btn-secondary w-100"><i class="dripicons-copy"></i> Download Excel</button>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $("ul#online_sale").siblings('a').attr('aria-expanded','true');
    $("ul#online_sale").addClass("show");
    $("ul#online_sale #sale-list-menu").addClass("active");
    ...
    $(document).on("click", ".create-packing-slip-btn", function (e) {
        ...
        $.get('online-sales/get-sold-items/'+id, function (data) {
    ...
    $(document).on("click", "table.sale-list tbody .get-payment", function(event) {
        ...
        $.get('online-sales/getpayment/' + id, function(data) {
                ...
                action: function ( e, dt, node, config ) {
                    if(user_verified == '1') {
                        ...
                        if(sale_id.length && confirm("Are you sure want to delete?")) {
                            $.ajax({
                                type:'POST',
                                url:'online-sales/deletebyselection',
                                data:{
                                    saleIdArray: sale_id
                                },
                                success:function(data){
    ...
    function saleDetails(sale){
        ...
        $.get('online-sales/product_sale/' + sale[13], function(data){
            // console.log(data);
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01-TR-LARAVEL\redpharma\resources\views/backend/online-sale/index.blade.php ENDPATH**/ ?>