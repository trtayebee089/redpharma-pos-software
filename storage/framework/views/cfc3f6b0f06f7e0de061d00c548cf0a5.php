...
<section>
    <div class="container-fluid">
        <?php if(in_array("sales-add", $all_permission)): ?>
            <a href="<?php echo e(route('sales.create')); ?>" class="btn btn-info add-sale-btn"><i class="dripicons-plus"></i> <?php echo e(__('file.Add Sale')); ?></a>&nbsp;
            <a href="<?php echo e(url('sales/sale_by_csv')); ?>" class="btn btn-primary add-sale-btn"><i class="dripicons-copy"></i> <?php echo e(__('file.Import Sale')); ?></a>
        <?php endif; ?>
        <div class="card mt-3">
            <h3 class="text-center mt-3"><?php echo e(__('file.Filter Sales')); ?></h3>
            <div class="card-body">
                ...
                <div class="row mt-2">
                    <div class="col-md-2">
                        <div class="form-group">
                            <label><strong><?php echo e(__('file.Date')); ?></strong></label>
                    ...
                    <div class="col-md-2 <?php if(\Auth::user()->role_id > 2): ?><?php echo e('d-none'); ?><?php endif; ?>">
                        <div class="form-group">
                            <label><strong><?php echo e(__('file.Warehouse')); ?></strong></label>
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            <label><strong><?php echo e(__('file.Sale Status')); ?></strong></label>
                            <select id="sale-status" class="form-control" name="sale_status">
                                <option value="0"><?php echo e(__('file.All')); ?></option>
                                <option value="1"><?php echo e(__('file.Completed')); ?></option>
                                <option value="2"><?php echo e(__('file.Pending')); ?></option>
                                <option value="4"><?php echo e(__('file.Returned')); ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-group">
                            <label><strong><?php echo e(__('file.Payment Status')); ?></strong></label>
                            <select id="payment-status" class="form-control" name="payment_status">
                                <option value="0"><?php echo e(__('file.All')); ?></option>
                                <option value="1"><?php echo e(__('file.Pending')); ?></option>
                                <option value="2"><?php echo e(__('file.Due')); ?></option>
                                <option value="3"><?php echo e(__('file.Partial')); ?></option>
                                <option value="4"><?php echo e(__('file.Paid')); ?></option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-2 mt-3">
                        <div class="form-group">
                            <button data-href="<?php echo e(url('sales/export-all')); ?>" id="btn-download-filter-data" class="btn btn-secondary w-100"><i class="dripicons-copy"></i> Download Excel</button>
                        </div>
                    </div>

                    <div class="col-md-2 mt-3">
                        <div class="form-group">
                            <button class="btn btn-primary w-100 text-capitalize" id="filter-btn" type="submit">Filter</button>
                        </div>
                    </div>
                </div>
                <?php echo Form::close(); ?>
    ...
    <div class="table-responsive">
        <table id="sale-table" class="table sale-list" style="width: 100%">
            <thead>
                <tr>
                    <th class="not-exported" width="2%"></th>
                    <th width="10%"><?php echo e(__('file.date')); ?></th>
                    <th width="10%"><?php echo e(__('file.reference')); ?></th>
                    <th width="10%">Billed By</th>
                    <th width="10%"><?php echo e(__('file.customer')); ?></th>
                    <th width="18%"><?php echo e(__('file.Products')); ?></th>
                    <th width="10%"><?php echo e(__('file.Total Quantity')); ?></th>
                    <th width="8%"><?php echo e(__('file.grand total')); ?></th>
                    <th width="8%"><?php echo e(__('file.Paid')); ?></th>
                    <th width="8%"><?php echo e(__('file.Due')); ?></th>
                    <th width="6%">Status</th>
                    <th width="5%" class="not-exported">
                        <?php echo e(__('file.action')); ?>
        ...
        <div class="modal-content">
            <div class="container mt-3 pb-2 border-bottom">
                <div class="row">
                    <div class="col-md-6 d-print-none">
                        <button id="print-btn" type="button" class="btn btn-default btn-sm"><i class="dripicons-print"></i> <?php echo e(__('file.Print')); ?></button>
                    ...
                    <div class="col-md-4 text-left">
                        <img src="<?php echo e(url('logo', $general_setting->site_logo)); ?>" width="90px;">
                    </div>
                    <div class="col-md-4 text-center">
                        <h3 id="exampleModalLabel" class="modal-title container-fluid"><?php echo e($general_setting->site_title); ?></h3>
                    </div>
                    <div class="col-md-4 text-right">
                        <i style="font-size: 15px;"><?php echo e(__('file.Sale Details')); ?></i>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-bordered product-sale-list">
                <thead>
                    ...
                    <th><?php echo e(__('file.Returned')); ?></th>
                    <th><?php echo e(__('file.Unit Price')); ?></th>
                    <th><?php echo e(__('file.Tax')); ?></th>
                    <th><?php echo e(__('file.Discount')); ?></th>
                    <th><?php echo e(__('file.Subtotal')); ?></th>
                    <th><?php echo e(__('file.Delivered')); ?></th>
                </thead>
                <tbody>
                </tbody>
            </table>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('packingSlip.store')); ?>" method="POST" class="packing-slip-form">
                <?php echo csrf_field(); ?>
                  <div class="row">
                        <input type="hidden" name="sale_id">
                            ...
                            <table class="table table-bordered table-hover product-list mt-3">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Qty</th>
                                        <th><?php echo e(__('file.Unit Price')); ?></th>
                                        <th><?php echo e(__('file.Total Price')); ?></th>
                                        <th><?php echo e(__('file.Packed')); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
...
<div id="view-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('file.All')); ?> <?php echo e(__('file.Payment')); ?></h5>
                ...
                <table class="table table-hover payment-list">
                    <thead>
                        <tr>
                            ...
                            <th><?php echo e(__('file.Account')); ?></th>
...
<div id="add-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('file.Add Payment')); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                <?php echo Form::open(['route' => 'sale.add-payment', 'method' => 'post', 'files' => true, 'class' => 'payment-form' ]); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label><?php echo e(__('file.Payment Receiver')); ?></label>
                            <input type="text" name="payment_receiver" class="form-control">
                        </div>
                    </div>
                    <div class="gift-card form-group">
                        <label> <?php echo e(__('file.Gift Card')); ?> *</label>
                    ...
                    <div id="cheque">
                        <div class="form-group">
                            <label><?php echo e(__('file.Cheque Number')); ?> *</label>
                            <input type="text" name="cheque_no" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                        <label> <?php echo e(__('file.Account')); ?></label>
                    ...
                    <div class="form-group">
                        <label><?php echo e(__('file.Payment Note')); ?></label>
...
<div id="edit-payment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('file.Update Payment')); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
...
<div id="add-delivery" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('file.Add Delivery')); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
...
<div id="send-sms" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 id="exampleModalLabel" class="modal-title"><?php echo e(__('file.Send SMS')); ?></h5>
                <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true"><i class="dripicons-cross"></i></span></button>
            </div>
            <div class="modal-body">
                <form action="<?php echo e(route('sale.sendsms')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-1">
                            <label><?php echo e(__('file.SMS Template')); ?></label>
                    ...
                    <button type="submit" class="btn btn-primary mt-2"><?php echo e(__('file.submit')); ?></button>
                </form>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $('#btn-download-filter-data').on('click', function(event){
        event.preventDefault();
        const startDate = $('input[name="starting_date"]').val();
        const endDate = $('input[name="ending_date"]').val();
    ...
    <?php if($lims_reward_point_setting_data): ?>
    ...
    function saleDetails(sale){
        ...
        var htmltext = '<strong><?php echo e(trans("file.date")); ?>: </strong>'+sale[0]+
            '<br><strong><?php echo e(trans("file.reference")); ?>: </strong>'+sale[1]+
            '<br><strong><?php echo e(trans("file.Warehouse")); ?>: </strong>'+sale[27]+
            '<br><strong><?php echo e(trans("file.Sale Status")); ?>: </strong>'+sale[2]+
            '<br><strong><?php echo e(trans("file.Currency")); ?>: </strong>'+sale[31];
        ...
        if(sale[33])
            htmltext += '<strong><?php echo e(trans("file.Table")); ?>: </strong>'+sale[33]+'<br>';
        if(sale[30])
            htmltext += '<strong><?php echo e(trans("file.Attach Document")); ?>: </strong><a href="documents/sale/'+sale[30]+'">Download</a><br>';

        htmltext += '<br><div class="row"><div class="col-md-6"><strong><?php echo e(trans("file.From")); ?>:</strong><br>'+sale[3]+'<br>'+sale[4]+'<br>'+sale[5]+'<br>'+sale[6]+'<br>'+sale[7]+'<br>'+sale[8]+
        '</div><div class="col-md-6"><div class="float-right"><strong><?php echo e(trans("file.To")); ?>:</strong><br>'+sale[9]+'<br>'+sale[10]+'<br>'+sale[11]+'<br>'+sale[12]+'</div></div></div>';
        ...
        $.get('sales/product_sale/' + sale[13], function(data){
            ...
            $.each(name_code, function(index) {
                ...
                var unitPrice = parseFloat(subtotal[index] / qty[index]).toFixed(<?php echo e($general_setting->decimal); ?>);
                ...
                if (toppings[index]) {
                    try {
                        ...
                        toppingPrices = toppingData
                            .map(topping => parseFloat(topping.price).toFixed(<?php echo e($general_setting->decimal); ?>)) // Extract and format each topping price
                ...
                cols += '<td>' + subtotal[index].toFixed(<?php echo e($general_setting->decimal); ?>) + '</td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=9><strong><?php echo e(trans("file.Order Tax")); ?>:</strong></td>';
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=9><strong><?php echo e(trans("file.Order Discount")); ?>:</strong></td>';
            cols += '<td>' + sale[19] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            if(sale[28]) {
                var newRow = $("<tr>");
                cols = '';
                cols += '<td colspan=9><strong><?php echo e(trans("file.Coupon Discount")); ?> ['+sale[28]+']:</strong></td>';
                cols += '<td>' + sale[29] + '</td>';
                newRow.append(cols);
                newBody.append(newRow);
            }
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=9><strong><?php echo e(trans("file.Shipping Cost")); ?>:</strong></td>';
            cols += '<td>' + sale[20] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=9><strong><?php echo e(trans("file.grand total")); ?>:</strong></td>';
            cols += '<td>' + sale[21] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=9><strong><?php echo e(trans("file.Paid Amount")); ?>:</strong></td>';
            cols += '<td>' + sale[22] + '</td>';
            newRow.append(cols);
            newBody.append(newRow);
            ...
            var newRow = $("<tr>");
            cols = '';
            cols += '<td colspan=9><strong><?php echo e(trans("file.Due")); ?>:</strong></td>';
...
<?php echo $__env->make('backend.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\01-TR-LARAVEL\redpharma\resources\views/backend/sale/index.blade.php ENDPATH**/ ?>